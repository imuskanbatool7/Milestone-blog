    ...
    return(
        <div className="min-h-screen bg-gradient-to-r  from-yellow-50 via-cyan-100 to-pink-100 ">
            ...
            <div className="bg-white shadow:cyan-600 rounded-lg mb-6 mt-0 p-4 md:p-10 max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl mt-3 font-bold mb-4 text-center text-cyan-800 font-serif">Let&apos;s Connect</h1>
                <p className="text-gray-800 text-xl  text-center font-serif mb-8 border-b-2 ">Whether you have a question, suggestion, or just want to share you&apos;r jeep adventure stories-drop us a message!</p>
                <form className="space-y-4 bg-slate-200 shadow-md shadow-cyan-200 rounded-lg p-5">
                <div>
                    <label className="block text-gray-700 text-lg font-bold font-serif"
                    >Your Name</label>
                    <input type="text" 
                ...
                <div>
                    <label
                    className=" block  text-gray-700 text-lg font-bold font-serif">Your Email</label>
                    <input type="text" 
